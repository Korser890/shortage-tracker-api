...
EIA_INVENTORY_SERIES = [
    ("PET.WCSSTUS1.W", 2, "WTI Crude Oil", "weekly"),
]
...
def run(start: str = None, end: str = None) -> None:
    ...
    logger.info(f"EIA inventory ingestion — range: {start} to {end}")

    for series_id, resource_id, label, frequency in EIA_INVENTORY_SERIES:
        try:
    ...
    logger.info("EIA inventory ingestion complete")
